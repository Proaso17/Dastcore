...
_KEYWORD_TO_CAT: list[tuple[str, tuple[str, ...]]] = [
    ...
    ("A01", ("idor", "bola", "bfla", "authz", "access-bypass", "access-control", "path-traversal",
             ...
             "forced-browsing", "unauth-access", "path-normalization", "verb-tampering", "vhost-routing")),
...
_CWE_TO_CAT: dict[str, str] = {
    ...
    "95": "A03", "96": "A03", "97": "A03", "98": "A03", "113": "A03", "116": "A03", "235": "A03",
    "564": "A03", "643": "A03", "644": "A03", "917": "A03", "943": "A03", "1336": "A03",
    # A04 Insecure Design
...
_ADVISORY_RULE_IDS: frozenset[str] = frozenset(
    {"scan-coverage", "spa-detected", "spa-awareness", "edge-posture"}
)
